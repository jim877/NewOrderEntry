...
export type AccessGroup  = { label: string; items: string[] };
export const PROPERTY_TYPES: PropertyType[] = config.lists.propertyTypes;
export const ACCESS_FOR_TYPE: Record<string, AccessGroup[]> = config.lists.accessForType;
export const ACCESS_DEFAULTS: Record<string, string[]> = config.lists.accessDefaults;
export type ScopeDepthLevel = { id: number; label: string; short: string; desc: string };
export const SCOPE_DEFAULTS: Record<string, "unit" | "building"> = config.lists.scopeDefaults as Record<string, "unit" | "building">;
export const LINKED_ROOMS: Record<string, string> = config.lists.linkedRooms;
export const SCOPE_DEPTH_LEVELS: ScopeDepthLevel[] = config.lists.scopeDepthLevels;
export type ReasonCode  = { code: string; label: string; desc: string; primary: boolean };
export type HandlingCode = { code: string; desc: string };
export const SCOPE_ROOM_LIST: string[]           = config.lists.scopeRoomList;
export const SCOPE_REASON_CODES: ReasonCode[]    = config.lists.scopeReasonCodes;
export const SCOPE_DEPARTMENTS: string[]         = config.lists.scopeDepartments;
export const SCOPE_HANDLING_CODES: HandlingCode[] = config.lists.scopeHandlingCodes;
export type InterviewStayType = { id: string; label?: string; desc: string };
export const INTERVIEW_PACKOUT_SCOPES: string[]      = config.lists.interviewPackoutScopes;
export const INTERVIEW_STAY_TYPES: InterviewStayType[] = config.lists.interviewStayTypes;
export const INTERVIEW_DURATION_OPTIONS: string[]    = config.lists.interviewDurationOptions;
export type OutboundAction = { key: string; label: string; desc: string; icon: string };
export const OUTBOUND_ACTIONS: OutboundAction[] = config.lists.outboundActions;
export type InterviewActionGroup = { label: string; keys: string[] };
export const INTERVIEW_ACTION_GROUPS: InterviewActionGroup[] = config.lists.interviewActionGroups;
export const LOADING_CATEGORIES: string[] = config.lists.loadingCategories;
export const AUDIT_STATUS_GATES: string[] = config.lists.auditStatusGates;
